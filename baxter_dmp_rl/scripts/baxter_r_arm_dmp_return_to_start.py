...
#    print('successfully get rot matrix')
    ...
    train_set = pd.read_csv('/home/karen/ros/indigo/baxter_ws/src/baxter_dmp/birl_baxter_dmp/dmp/datasets/right_limb_return_to_start.csv')
   ...
   # move to starting agles
    ...
    fileCount = 0
    goal_angle = [0.7858, -1.0485, 0.0821, 1.172, -0.1185, 1.4005, -0.0487]
    ###
    ...
    while ( fileCount < 1 and not rospy.is_shutdown() ) :
        ...
        WriteFileDir = "/home/karen/ros/indigo/baxter_ws/src/baxter_dmp/birl_baxter_dmp/dmp/datasets/right_limb_return_to_start0.csv" 
