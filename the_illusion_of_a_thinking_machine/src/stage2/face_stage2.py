...
def baxter_suprise():
    img = cv2.imread("/home/vmrguser/ros/indigo/baxter_ws/src/birl_baxter/demos//the_illusion_of_a_thinking_machine/BaxterFace/surprise1.png")
    msg = cv_bridge.CvBridge().cv2_to_imgmsg(img, encoding="bgr8")
    pub = rospy.Publisher('/robot/xdisplay', Image, latch=True, queue_size=1)
    pub.publish(msg)
    rospy.sleep(1)
    img = cv2.imread("/home/vmrguser/ros/indigo/baxter_ws/src/birl_baxter/demos//the_illusion_of_a_thinking_machine/BaxterFace/surprise2.png")
    msg = cv_bridge.CvBridge().cv2_to_imgmsg(img, encoding="bgr8")
    pub = rospy.Publisher('/robot/xdisplay', Image, latch=True, queue_size=1)
    pub.publish(msg)
    rospy.sleep(0.17)
