#include "Pid_SRIvar_TrackingController.h"
// #include <Eigen/Dense>
// #include <iostream>
...
Pid_SRIvar_TrackingController::Pid_SRIvar_TrackingController(DQ_kinematics robot, VectorXd upper_joint_limits, VectorXd lower_joint_limits, MatrixXd feedback_gain, double beta, double lambda_max, double epsilon) : DQ_controller()
{
...
VectorXd Pid_SRIvar_TrackingController::getNewJointPositions( const DQ reference, const VectorXd thetas)
{
