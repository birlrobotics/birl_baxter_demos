...
pieces(highlight)
{
    ...
    is = it->subscribe("/christest", 1, &Camera::callback, this);
    if(is == NULL)
    {
        std::cout << std::right << "\033[1;31m[Failed]\033[0m" << std::endl;
        return;
